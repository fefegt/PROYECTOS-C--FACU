...
//18-INGRESAR C?DIGO DE ARTICULO Y PRECIO, HASTA UN C?DIGO DE ARTICULO IGUAL 0,
...
int main(){
	...
	while (articulo[0] != '0'){ //comparo solo con la primer posici?n porque sino no funciona
